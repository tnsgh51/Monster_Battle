...
public class S_Analysis_Battle {
	...
	public S_Analysis_Battle(S_Analysis s_Analysis) {
		...
		battleList = s_Analysis.getBattleList();
				...
				for (int i = 0; i < brList.size(); i++) {
					if (s_tc.equals(brList.get(i).getI1().getS_tc())) {
						...
						brList.get(i).getK().setSend_msg(brList.get(i).getK()
								...
								+ "의 공격!\n"
								+ (int) (brList.get(i).getK()
										.getId1_Monster_ad(brList.get(i).getK().getId1_now_monster())
										* f
										/ brList.get(i).getK()
												.getId2_Monster_shield(brList.get(i).getK().getId2_now_monster()))
								+ "의 데미지!!!\n");
						...
						brList.get(i).getK().setSend_msg(
								brList.get(i).getK().getSend_msg() + brList.get(i).getK().getNow_turn() + "의 차례\n");
						...
						brList.get(i).getK().setSend_msg(brList.get(i).getK()
								...
								+ "의 공격!\n"
								+ (int) (brList.get(i).getK()
										.getId2_Monster_ad(brList.get(i).getK().getId2_now_monster())
										* f
										/ brList.get(i).getK()
												.getId1_Monster_shield(brList.get(i).getK().getId1_now_monster()))
								+ "의 데미지!!!\n");
			...
			case "skill":
				for (int i = 0; i < brList.size(); i++) {
					if (s_tc.equals(brList.get(i).getI1().getS_tc())) {
						...
						String[][] skillList = brList.get(i).getK()
								.getId1_Monster_skill(brList.get(i).getK().getId1_now_monster());

						int ran = r.nextInt(100) + 1;

						if (ran <= Integer.parseInt(skillList[Integer.parseInt(e)][2])) {

							brList.get(i).getK().setId2_Monster_hp_now(brList.get(i).getK().getId2_now_monster(), brList
									.get(i).getK().getId2_Monster_hp_now(brList.get(i).getK().getId2_now_monster())
									- (int) (Integer.parseInt(skillList[Integer.parseInt(e)][1]) * f / brList.get(i)
											.getK().getId2_Monster_shield(brList.get(i).getK().getId2_now_monster())));

							brList.get(i).getK().setSend_msg(brList.get(i).getK()
									.getId1_Monster_nickname(brList.get(i).getK().getId1_now_monster()) + "의 "
									+ skillList[Integer.parseInt(e)][0] + "!\n"
									+ (int) (Integer.parseInt(skillList[Integer.parseInt(e)][1]) * f
											/ brList.get(i).getK()
													.getId2_Monster_shield(brList.get(i).getK().getId2_now_monster()))
									+ "의 데미지!!!\n");
							...
							brList.get(i).getK()
									.setSend_msg(brList.get(i).getK()
											.getId1_Monster_nickname(brList.get(i).getK().getId1_now_monster()) + "의 "
											+ skillList[Integer.parseInt(e)][0] + "!\n"
											+ skillList[Integer.parseInt(e)][0] + "은 빗나갔다.\n");
						}
						brList.get(i).getK().setNow_turn(brList.get(i).getK().getId2());
						brList.get(i).getK().setSend_msg(
								brList.get(i).getK().getSend_msg() + brList.get(i).getK().getNow_turn() + "의 차례\n");
						...
						String[][] skillList = brList.get(i).getK()
								.getId2_Monster_skill(brList.get(i).getK().getId2_now_monster());
						...
						if (ran <= Integer.parseInt(skillList[Integer.parseInt(e)][2])) {
							...
							brList.get(i).getK().setId1_Monster_hp_now(brList.get(i).getK().getId1_now_monster(), brList
									.get(i).getK().getId1_Monster_hp_now(brList.get(i).getK().getId1_now_monster())
									- (int) (Integer.parseInt(skillList[Integer.parseInt(e)][1]) * f / brList.get(i)
											.getK().getId1_Monster_shield(brList.get(i).getK().getId1_now_monster())));

							brList.get(i).getK().setSend_msg(brList.get(i).getK()
									.getId2_Monster_nickname(brList.get(i).getK().getId2_now_monster()) + "의 "
									+ skillList[Integer.parseInt(e)][0] + "!\n"
									+ (int) (Integer.parseInt(skillList[Integer.parseInt(e)][1]) * f
											/ brList.get(i).getK()
													.getId1_Monster_shield(brList.get(i).getK().getId1_now_monster()))
							...
							brList.get(i).getK()
									.setSend_msg(brList.get(i).getK()
											.getId2_Monster_nickname(brList.get(i).getK().getId1_now_monster()) + "의 "
											+ skillList[Integer.parseInt(e)][0] + "!\n"
											+ skillList[Integer.parseInt(e)][0] + "은 빗나갔다.\n");
						}
	...
	public void battleSave1(int i) {
		DAO_Interface dao = DAO_BattleList.getInstance();

		DTO_BattleList battle = new DTO_BattleList();

		battle.setId(brList.get(i).getK().getId2());
		battle.setResult("1");
		battle.setOpponent(brList.get(i).getK().getId1());
		battleList.add(battle);
		brList.get(i).getI2().addMyList(battle);
		dao.insert(battle);

		battle = new DTO_BattleList();

		battle.setId(brList.get(i).getK().getId1());
		battle.setResult("0");
		battle.setOpponent(brList.get(i).getK().getId2());
		battleList.add(battle);
		brList.get(i).getI1().addMyList(battle);
		dao.insert(battle);

	}

	public void battleSave2(int i) {
