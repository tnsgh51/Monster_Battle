...
public class TC_Object implements Serializable {
	...
	public String[] getId1_Monster_img() {
		return id1_Monster_img;
	}
	...
	public String[] getId2_Monster_img() {
		return id2_Monster_img;
	}
